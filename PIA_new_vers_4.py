...
# DRAW OVERLAY
# =======================================================
def make_overlay_image(mves, comp, react, cond_1, cond_2, residual_heat, reactor_temp, react_pressure_barg, ia_react_out_wat,ia_react_out_HAc,ia_react_out_IA):
    img = base_img.copy()
    ...
    #a = int((ia_react_out_wat/(ia_react_out_wat + ia_react_out_IA + ia_react_out_HAc))*3000)
    #b = int((ia_react_out_HAc/(ia_react_out_wat + ia_react_out_IA + ia_react_out_HAc))*3000)
    #c = int((ia_react_out_IA/(ia_react_out_wat + ia_react_out_IA + ia_react_out_HAc))*3000)
    total_liq = ia_react_out_wat/18 + ia_react_out_HAc/60 + ia_react_out_IA/166

    if total_liq > 0:
        water_frac = ia_react_out_wat/18 / total_liq
        hac_frac = ia_react_out_HAc/60 / total_liq
        ia_frac = ia_react_out_IA/166/ total_liq

        r = int(water_frac * 255*6)
        g = int(hac_frac * 255*2)
        b = int(ia_frac * 255*4)
    else:
        r, g, b = 180, 180, 180
    ...
    print("RGB =", r, g, b)
    #draw.rectangle((445,445,550,580),fill=(a,b,c), outline="blue",width = 2)
    #print ("a = " ,a)
    return img
