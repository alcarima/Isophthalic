...
# OPENING PAGE
# =======================================================
OPENING_BG = "#FFA94D"        # light orange
TITLE_COLOR = "#1E3A5F"     # dark blue
SUBTITLE_COLOR = "#2563EB"  # company light blue
TEXT_COLOR = "#374151"      # dark grey
BUTTON_BG = "#60A5FA"       # light blue

opening_frame = tk.Frame(root, bg=OPENING_BG)
opening_frame.pack(fill="both", expand=True)
...
tk.Label(
    opening_frame,
    text="Make your process visible",
    bg=OPENING_BG,
    fg=SUBTITLE_COLOR,
    font=("Arial", 24, "bold")
).pack(pady=10)
...
tk.Label(
    opening_frame,
    text="Offline simulation  •  Online monitoring  •  Zero Loss  •  Operator guidance",
    bg=OPENING_BG,
    fg=TEXT_COLOR,
    font=("Arial", 16)
).pack(pady=15)
...
tk.Label(
    opening_frame,
    text="A visibility and understanding layer for process plants",
    bg=OPENING_BG,
    fg=TEXT_COLOR,
    font=("Arial", 15)
).pack(pady=(10, 35))
...
# IMPORTANT:
# Do not pack main_frame here.
# It will be packed only after pressing "Enter Plant".
